// Resolve opaque player tokens to their wrapper iframe URL via upstream's
// sinta.{root} proof-of-work challenge:
//   GET  sinta.{root}/challenge.php?id={token} → { challenge, difficulty }
//   solve SHA-256 hashcash: SHA-256(challenge + nonce) starts with N zeros
//   POST sinta.{root}/verify.php { challenge, nonce, id, fp } → { url }
//
// Public API:
